...
Rules:
- Use AI Memory as the primary knowledge base.
- Do not use separate uploaded files. The only knowledge source is AI Memory plus current conversation.
...
- If the answer is not in AI Memory, say you need to check/review internally.
...
Return ONLY valid JSON:
{
  ...
  "sourceBasis": "what AI Memory/general safe basis was used"
}`;

    const userPrompt = `MODE: ${mode}
AI MEMORY COUNT: ${memoryCount}
...
AI MEMORY:
${aiMemory ? clampText(aiMemory, 28000) : 'No AI Memory loaded. Use safe customer service language and tell Carl to check internally for company-specific answers.'}
